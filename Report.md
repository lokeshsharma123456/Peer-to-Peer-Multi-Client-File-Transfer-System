...
* [Semaphores:](https://www.geeksforgeeks.org/semaphores-in-process-synchronization/amp/) Semaphore is simply a variable that is non-negative and shared between [threads](https://www.geeksforgeeks.org/thread-in-operating-system/amp/). This variable is used to solve the [critical section problem](https://www.geeksforgeeks.org/g-fact-70/amp/) and to achieve [process synchronization](https://www.geeksforgeeks.org/introduction-of-process-synchronization/amp/) in the [multiprocessing environment](https://www.geeksforgeeks.org/difference-between-multiprocessing-and-multithreading/amp/).
...
* serverSocket:[Socket descriptor](https://www.geeksforgeeks.org/socket-programming-cc/amp/), an integer (like a file-handle).
* domain: Integer, communication domain e.g., AF_INET ([IPv4 protocol](https://www.geeksforgeeks.org/introduction-and-ipv4-datagram-header/amp/)), AF_INET6 ([IPv6 protocol](https://www.geeksforgeeks.org/internet-protocol-version-6-ipv6/amp/)).
* type: Communication type.
* SOCK_STREAM:[TCP](https://www.geeksforgeeks.org/tcp-ip-model/amp/)(reliable, connection-oriented).
* SOCK_DGRAM:[UDP](https://www.geeksforgeeks.org/user-datagram-protocol-udp/amp/)(unreliable, connectionless).
* protocol: Protocol value for Internet Protocol(IP), which is 0. This is the same number that appears on the protocol field in the [IP header](https://www.geeksforgeeks.org/introduction-and-ipv4-datagram-header/amp/)of a packet.(man protocols for more details).

Then, after initializing all the necessary variables, [bind the socket](https://www.geeksforgeeks.org/socket-programming-cc/amp/).

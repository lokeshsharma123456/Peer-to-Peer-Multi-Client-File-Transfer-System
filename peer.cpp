...
{
    struct Server server = server_constructor(AF_INET, SOCK_STREAM, 0, INADDR_ANY, 1248, 0);
...
{
    struct Client client = client_constructor(AF_INET, SOCK_STREAM, 0, 8080, INADDR_ANY);
